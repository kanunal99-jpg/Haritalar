...
'''
if old not in text:
    raise SystemExit("route-options traffic block not found")
...
'''
if old not in text:
    raise SystemExit("navigation traffic block not found")
text = text.replace(old, new, 1)
...
'''
if old not in text:
    raise SystemExit("drawRoute block not found")
text = text.replace(old, new, 1)

MAIN.write_text(text)

helper = Path("core/src/main/kotlin/com/haritalar/core/traffic/TrafficRouteMapPresentation.kt")
helper.parent.mkdir(parents=True, exist_ok=True)
helper.write_text('''package com.haritalar.core.traffic
...
test = Path("core/src/test/kotlin/com/haritalar/core/traffic/TrafficRouteMapPresentationTest.kt")
test.parent.mkdir(parents=True, exist_ok=True)
test.write_text('''package com.haritalar.core.traffic
